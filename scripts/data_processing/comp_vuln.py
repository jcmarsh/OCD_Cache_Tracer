...
# Do this by stepping through each valid_lines
# base time off of cycles

# This script incorporates the more complicated understanding of store instructions operating on a cache-line level instead of word.
...
total_word_count = L2_SIZE_B / WORD_SIZE_B
...
# TODO: Am I dealing with ways correctly? <- lines are identified by tag+l2_set, so multiple l2_set entries can exist. It doesn't count them (infinite ways)
...
for valid_line in valid_lines:
    ...
    ####-- Cache Vulnerability --####
    # TODO: Shift to word based
    # TODO: Deal with cycle_out for store instructions (unchanged words read from cache, changed words still use cycle_last used)
    ...
    ####-- Cache Utilization --####
    # TODO: Change to word based compared to simple_vuln.py
    if cycle_out == -1:
        cycle_out = end_cycle
    ...
    # TODO: Shift to word based
    # TODO: Need to also include the store on cycle out?
...
for i in range(0, len(vuln_steps)):
    # TODO: Also print out number of possible wordspossible words
